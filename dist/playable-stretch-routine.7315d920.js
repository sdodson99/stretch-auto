...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/models/stretch-routines/playable-stretch-routine.js":[function(require,module,exports) {
function PlayableStretchRoutine(routine, playerFactory) {
  ...
  this.start = function _callee() {
    var i, currentSet, currentStretch;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.next = 10;
            return regeneratorRuntime.awrap(this.onSetChange(currentSet));
          ...
          case 12:
            currentStretch = this.stretches[i];
            this.currentPlayer = this.createStretchPlayer(currentStretch);
            _context.next = 16;
            return regeneratorRuntime.awrap(this.onStretchChange(currentStretch));
          ...
          case 18:
            _context.next = 20;
            return regeneratorRuntime.awrap(this.currentPlayer.start());
          ...
          case 26:
            _context.next = 28;
            return regeneratorRuntime.awrap(this.onFinish());
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/models/stretch-routines/playable-stretch-routine.js"], null)
//# sourceMappingURL=/playable-stretch-routine.7315d920.js.map