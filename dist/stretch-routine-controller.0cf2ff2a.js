...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/controllers/stretch-routine-controller.js":[function(require,module,exports) {
function StretchRoutineController(routine, view, navigator, handlerFactory, options) {
  ...
  this.startRoutine = function _callee() {
    var _this = this;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            this.view.addPauseHandler(function () {
              return _this.onPause();
            });
            this.view.addCancelHandler(function () {
            ...
            _context.next = 10;
            return regeneratorRuntime.awrap(this.routine.start());
  ...
  this.onStretchChange = function _callee2(stretch) {
    var _this2 = this;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (stretch.instructions) {
              stretch.instructions.forEach(function (i) {
                _this2.view.addInstruction(i);
              });
            }

            this.currentStretch = stretch;
            _context2.next = 7;
            return regeneratorRuntime.awrap(this.stretchHandler.onStretchChange(this, stretch));
  ...
  this.onSetChange = function _callee3(set) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            this.currentSet = set;
            _context3.next = 4;
            return regeneratorRuntime.awrap(this.stretchHandler.onSetChange(this, set));
  ...
  this.onTimeChange = function _callee4(time) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return regeneratorRuntime.awrap(this.stretchHandler.onTimeChange(this, time));
  ...
  this.onFinish = function _callee5() {
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/controllers/stretch-routine-controller.js"], null)
//# sourceMappingURL=/stretch-routine-controller.0cf2ff2a.js.map